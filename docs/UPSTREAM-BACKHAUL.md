> **یادداشت FarsHub:** این فایل README اصلی پروژه‌ی آپ‌استریم
> (`github.com/musix/backhaul`) است و بدون تغییر آرشیو شده، چون مرجع کامل
> کلیدهای TOML است — نام این کلیدها داخل باینری کامپایل شده و قابل تغییر نیست.
> در متن زیر `backhaul` را `farshub` بخوانید. برای نصب و کانفیگ FarsHub به
> [README اصلی](../README.md) مراجعه کنید. برای مبدأ باینری به
> [ORIGIN.md](ORIGIN.md).
