...
export const STRINGS = {
  fa: {
    ...
    'ports.empty.body': 'پورت‌ها را در فایل کانفیگ تعریف کنید تا اینجا نمایش داده شوند.',
  ...
  en: {
    ...
    'ports.empty.body': 'Define ports in the config file and they will appear here.',
